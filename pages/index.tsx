...
export default function App() {
  ...
  return (
    <div className="relative bg-white h-screen">
      ...
      <section className="relative w-full h-screen overflow-hidden bg-center bg-no-repeat bg-cover bg-patternTop">
        <div className="container relative w-full px-8 pt-32 pb-24 mx-auto lg:px-4">
          <div className="flex flex-col w-full mb-12 text-left lg:text-center">
            ...
            <strong className="mb-4 text-lg font-bold tracking-widest uppercase text-slate-500">
              LEARN2IMPACT
            </strong>
            <h1 className="mb-6 font-serif text-4xl font-bold tracking-tighter text-[#385738] md:text-10xl lg:text-8xl">
              ZENA
            </h1>
            <p className="mx-auto text-xl leading-snug text-slate-500 lg:w-1/2">
              a Web3 climate-app enabling users to combine learning with impact
              and climate action.
            </p>
          </div>
        ...
        <div className="container px-5 py-32 mx-auto lg:px-24">
          <div className="flex flex-col w-full mb-20 text-left lg:text-center">
            ...
            <p className="mx-auto text-lg leading-snug text-slate-500">
              ZENA app users will earn CO2-backed tokens by completing learning
              chapters and quests. These tokens can be exchanged into a
              certificate NFT, sequestering CO2.
            </p>
            <p className="mx-auto mt-12 text-2xl font-bold leading-snug text-slate-500">
              How it works
            </p>
          </div>
          <div className="flex flex-wrap -mx-4 -mt-4 -mb-10 space-y-6 sm:-m-4 md:space-y-0">
            <div className="flex p-4 lg:w-1/3">
              <div className="inline-flex items-center justify-center flex-shrink-0 w-12 h-12 mb-4 text-[#385738] rounded-full bg-slate-200">
                <svg
                  fill="none"
                  stroke="currentColor"
              ...
              <div className="flex-grow pl-6">
                <h3 className="font-serif text-2xl font-semibold text-[#385738]">
                  Create User Account
                </h3>
                <p className="mt-6 text-lg text-slate-500">
                  After creating ZENA user account, you can access predefined
                  learning chapters. Start your journey into Web3, or any other
                  topic prepared by our educators.
                </p>
              </div>
            </div>
            <div className="flex p-4 lg:w-1/3">
            ...
            <div className="flex p-4 lg:w-1/3">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="mt-6 text-lg text-slate-500">
                  Finished a whole learning module? You're ready to mint your
                  NFT certificate!
                </p>
              </div>
            </div>
      ...
      <section className="pt-6 overflow-hidden bg-patternBottom">
        <div className="container relative flex flex-col items-center px-5 py-16 mx-auto lg:px-24 lg:py-24 md:flex-row">
          <div className="mx-auto mb-10 md:mb-0">
            <img
              className="object-cover object-center mx-auto rounded md:mt-44 lg:-mt-44"
              alt="hero"
              src="zena_tree_evolution.png"
            />
          </div>
        </div>
      </section>
        ...
        <div className="px-5 py-12 mx-auto max-w-7xl sm:px-6 md:flex md:items-center md:justify-between lg:px-12">
          <div className="flex justify-center mb-8 space-x-6 md:order-last md:mb-0">
            <span className="text-white hover:text-blue-600">
              Built with &hearts; in Berlin & Barcelona
            </span>
            <a
              href="https://twitter.com/zena_academy"
